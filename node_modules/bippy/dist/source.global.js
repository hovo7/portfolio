...
react/cjs/react.production.js:
   ...
   * LICENSE file in the root directory of this source tree.
   *)
*/return e.BIPPY_INSTRUMENTATION_STRING=T,e.CONCURRENT_MODE_NUMBER=60111,e.CONCURRENT_MODE_SYMBOL_STRING=W,e.ClassComponentTag=1,e.ContextConsumerTag=9,e.DEPRECATED_ASYNC_MODE_SYMBOL_STRING=q,e.DehydratedSuspenseComponentTag=18,e.ELEMENT_TYPE_SYMBOL_STRING=z,e.ForwardRefTag=11,e.FragmentTag=7,e.FunctionComponentTag=0,e.HostComponentTag=5,e.HostHoistableTag=26,e.HostRootTag=3,e.HostSingletonTag=27,e.HostTextTag=6,e.INSTALL_ERROR=ge,e.INSTALL_HOOK_SCRIPT_STRING="(()=>{try{var t=()=>{};const n=new Map;let o=0;globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__={checkDCE:t,supportsFiber:!0,supportsFlight:!0,hasUnsupportedRendererAttached:!1,renderers:n,onCommitFiberRoot:t,onCommitFiberUnmount:t,onPostCommitFiberRoot:t,inject(t){var e=++o;return n.set(e,t),globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__._instrumentationIsActive=!0,e},_instrumentationIsActive:!1,_script:!0}}catch{}})()",e.LegacyHiddenComponentTag=23,e.MemoComponentTag=14,e.OffscreenComponentTag=22,e.SimpleMemoComponentTag=15,e.SuspenseComponentTag=13,e.TRANSITIONAL_ELEMENT_TYPE_SYMBOL_STRING=V,e._fiberRoots=he,e.createFiberVisitor=({onRender:e})=>(n,t,r)=>{me(t,e)},e.detectReactBuildType=te,e.didFiberCommit=Q,e.didFiberRender=J,e.fiberIdMap=oe,e.getDisplayName=ne,e.getFiberFromHostInstance=e=>{const n=G();for(const t of n.renderers.values())try{const n=t.findFiberByHostInstance?.(e);if(n)return n}catch{}if("object"==typeof e&&null!=e){if("_reactRootContainer"in e)return e._reactRootContainer?._internalRoot?.current?.child;for(const n in e)if(n.startsWith("__reactInternalInstance$")||n.startsWith("__reactFiber"))return e[n]||null}return null},e.getFiberId=se,e.getFiberSource=async e=>{const n=e._debugSource;if(n){const{fileName:e,lineNumber:t}=n;return{fileName:e,lineNumber:t,columnNumber:"columnNumber"in n&&"number"==typeof n.columnNumber?n.columnNumber:0}}if(e.memoizedProps?.__source)return e.memoizedProps.__source;const t=G();let r=Oe?.ReactCurrentDispatcher||Oe?.H;for(const e of t.renderers.values())if(r=e.currentDispatcherRef,r)break;if(!r)return null;const o=Y(e)?ee(Z(e,(e=>{if(K(e))return!0}),!0)):ee(e.type);if(!o||ve)return null;const i=Re(o,1===e.tag,Oe);return Se(i)},e.getFiberStack=e=>{const n=[];let t=e;for(;t.return;)n.push(t),t=t.return;return n},e.getLatestFiber=e=>{const n=e.alternate;if(!n)return e;if(n.actualStartTime&&e.actualStartTime)return n.actualStartTime>e.actualStartTime?n:e;for(const t of he){return Z(t.current,(n=>{if(n===e)return!0}))||n}return e},e.getMutatedHostFibers=e=>{const n=[],t=[e];for(;t.length;){const e=t.pop();e&&(Y(e)&&Q(e)&&J(e)&&n.push(e),e.child&&t.push(e.child),e.sibling&&t.push(e.sibling))}return n},e.getNearestHostFiber=(e,n=!1)=>{let t=Z(e,Y,n);return t||(t=Z(e,Y,!n)),t},e.getNearestHostFibers=e=>{const n=[],t=[];for(Y(e)?n.push(e):e.child&&t.push(e.child);t.length;){const e=t.pop();if(!e)break;Y(e)?n.push(e):e.child&&t.push(e.child),e.sibling&&t.push(e.sibling)}return n},e.getRDTHook=G,e.getTimings=e=>{const n=e?.actualDuration??0;let t=n,r=e?.child??null;for(;n>0&&null!=r;)t-=r.actualDuration??0,r=r.sibling;return{selfTime:t,totalTime:n}},e.getType=ee,e.hasMemoCache=e=>Boolean(e.updateQueue?.memoCache),e.hasRDTHook=H,e.installRDTHook=x,e.instrument=de,e.isClientEnvironment=$,e.isCompositeFiber=K,e.isHostFiber=Y,e.isInstrumentationActive=()=>{const e=G();return Boolean(e._instrumentationIsActive)||P()||k()},e.isReactRefresh=k,e.isRealReactDevtools=P,e.isValidElement=e=>"object"==typeof e&&null!=e&&"$$typeof"in e&&[z,V].includes(String(e.$$typeof)),e.isValidFiber=e=>"object"==typeof e&&null!=e&&"tag"in e&&"stateNode"in e&&"return"in e&&"child"in e&&"sibling"in e&&"flags"in e,e.mountFiberRecursively=ae,e.onCommitFiberRoot=e=>de(_e({onCommitFiberRoot:(n,t)=>{e(t)}})),e.patchRDTHook=B,e.safelyInstallRDTHook=()=>{try{$()&&G()}catch{}},e.secure=_e,e.setFiberId=ie,e.shouldFilterFiber=X,e.traverseContexts=(e,n)=>{try{const t=e.dependencies,r=e.alternate?.dependencies;if(!t||!r)return!1;if("object"!=typeof t||!("firstContext"in t)||"object"!=typeof r||!("firstContext"in r))return!1;let o=t.firstContext,i=r.firstContext;for(;o&&"object"==typeof o&&"memoizedValue"in o||i&&"object"==typeof i&&"memoizedValue"in i;){if(!0===n(o,i))return!0;o=o?.next,i=i?.next}}catch{}return!1},e.traverseFiber=Z,e.traverseProps=(e,n)=>{try{const t=e.memoizedProps,r=e.alternate?.memoizedProps||{},o=new Set([...Object.keys(r),...Object.keys(t)]);for(const e of o){const o=r?.[e],i=t?.[e];if(!0===n(e,i,o))return!0}}catch{}return!1},e.traverseRenderedFibers=me,e.traverseState=(e,n)=>{try{let t=e.memoizedState,r=e.alternate?.memoizedState;for(;t||r;){if(!0===n(t,r))return!0;t=t?.next,r=r?.next}}catch{}return!1},e.unmountFiber=le,e.unmountFiberChildrenRecursively=ce,e.updateFiberRecursively=ue,e.version=L,e}({});